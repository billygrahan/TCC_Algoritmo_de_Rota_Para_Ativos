...
urbanos distribuídos por diferentes regiões da cidade. Este trabalho propõe o desenvolvimento de uma 
solução algorítmica baseada em técnicas heurísticas para otimização de rotas de visitação a ativos 
públicos, aplicando o Problema do Caixeiro Viajante ao contexto da gestão pública municipal. Foi 
realizada uma revisão sistemática da literatura para identificar as principais abordagens metodológicas 
e algoritmos utilizados em problemas de otimização de rotas em ambientes urbanos e cidades inteligentes. A metodologia 
