...
\autor{Billy Grahan Alves Rodrigues}
\titulo{ALGORITMOS DE BUSCA PARA Identificação DE ROTAS ENTRE ATIVOS NA ZELADORIA PÚBLICA NO CONTEXTO DE CIDADES INTELIGENTES}
\data{2026}
\local{Russas}
...
\orientador{Prof. Dr. Mayrton Dias de Queiroz}
...
\membrodabancadois{Prof. Ms. Caio César de Freitas Dantas}
% \membrodabancadoiscentro{Universidade Federal do Ceará (UFC)}
\membrodabancadoisies{Universidade Federal do Ceará (UFC)}
\membrodabancatres{Prof. Esp. Gildo Adriano Norberto da Silva}
% \membrodabancatrescentro{Centro de Ciências e Tecnologia (CCT)}
\membrodabancatresies{Universidade Federal Rural de Pernambuco (UFRPE)}
