...
profundos \cite{CORMEN2012}. O algoritmo utiliza uma estrutura de fila (do inglês, \gls{FIFO}) para controlar a ordem de visitação dos vértices.
...
recursivamente ou utilizando uma pilha (do inglês, \gls{LIFO}). A \gls{DFS} também possui 
complexidade $O(V + E)$.
