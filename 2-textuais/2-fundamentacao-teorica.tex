...
O algoritmo \gls{A*} é uma extensão da busca de custo uniforme que incorpora uma função heurística 
...
Para que o \gls{A*} garanta encontrar o caminho ótimo, a heurística deve ser admissível, ou seja, 
...
O \gls{A*} é particularmente eficiente quando existe uma boa heurística disponível, pois reduz 
