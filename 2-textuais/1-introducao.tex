...
encontram-se com algum problema, seja para conserto, manutenção ou reposição por diferentes regiões da cidade, exigindo um planejamento logístico criterioso que minimize 
o tempo de deslocamento e os custos operacionais das equipes responsáveis.

No contexto das cidades inteligentes — ambientes urbanos que utilizam Tecnologias da Informação e 
Comunicação (TIC) para melhorar a infraestrutura, os serviços públicos e a qualidade de vida dos 
cidadãos \cite{WEISS2015} — a otimização de rotas torna-se fundamental para a eficiência 
...
e de infraestrutura são mais acentuadas \cite{SANTIAGO2023}.
...
utilizando um algoritmo heuristico conforme a realidade da gestão pública.

\subsection{Objetivos específicos}
    Para alcançar o objetivo geral, estabelecem-se os seguintes objetivos específicos:
\begin{itemize}
    \item Obter um levantamento dos principais trabalhos relacionados 
    à otimização de rotas em contextos urbanos e cidades inteligentes, bem como as técnicas e algoritmos empregados;
    \item Identificar os principais conceitos sobre o Problema do Caixeiro Viajante e suas variantes, contextualizando suas 
    aplicações na gestão de ativos públicos municipais;
    \item Identificar um algoritmo heurístico para geração de rotas otimizadas, 
...
O Capítulo 5 detalha a implementação do algoritmo desenvolvido, apresentando os resultados 
obtidos a partir de testes realizados gerar graficos comparativos e análises de desempenho.

Por fim, o Capítulo 6 consolida as conclusões do trabalho, sintetizando os principais 
